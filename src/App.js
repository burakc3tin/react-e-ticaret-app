...
export default function App() {
  ...
  useEffect(() => {
    // yükleme gecikmesi simüle etme
    setTimeout(() => {
      setIsLoading(false); // Gecikmeden sonra isLoading false olarak ayarlanır (ör. 2000 ms)
  ...
  return (
    <>
      <div className="bg">
        {isLoading ? (
          <Preloader /> // Yükleme sırasında Preloader componenti işlenir
        ) : (
          <>
